...
- **Version** : meae-consulaire-4.13.3
- **Date** : 2026-01-21 19:07:58
- **Commit** : 4effc4a873
- **Auteur** : jenkins
...
- `app.bundle.js`: `0647c5c049d2363468236ac043ac79a5a30beedce44828f0cf3eefa32e57a367`
- `crypto.bundle.js`: `dd5b59dfd62124dd3746242c0009608398b16558fa083fc944be670dffa65e0e`
- `354.chunk.js`: `ee2de8df59832e508b66ec8ed4958724154bb8a34f4b038e89b66a18c98543ba`
- `399.chunk.js`: `182c48ca1d9103552d55234c7e1f0d9099a7a709de5a4a4be34a97e33e13013f`
- `418.chunk.js`: `643e4fd34b1861baf98ee402a1183f687b38c96aa2e082f040f093cb42b14710`
- `500.chunk.js`: `3ff7a823f6263cc5ae082c585825654f8773a3950b53eea3f6fba54c234a4e38`
---
...
1. **Vérifiez la version :** Assurez-vous de comparer le bon tag Git (meae-consulaire-4.13.3)
...
4. **Signalez l'anomalie :** Si le problème persiste, contactez support@voxaly.com (A MODIFIER MEAE)
...
- npm
- Java 17+ et Maven 3.6.3+ (pour la compilation complète)
...
npm ci  # Utiliser npm ci (pas npm install) pour garantir les versions exactes
```
...
- ✅ **NODE_ENV=production** : Mode de build cohérent
...
**Pour les électeurs :**
- Questions sur la vérification : support@voxaly.com (A MODIFIER MEAE)

**Pour les auditeurs techniques :**
- GitHub Issues : [https://github.com/Voxaly/meae-consulaires-2026/issues](https://github.com/Voxaly/meae-consulaires-2026/issues)
- Email technique : support@voxaly.com
