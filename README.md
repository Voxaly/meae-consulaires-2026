...
**[📄 Spécifications publiques VPI - meae_vpi_n_specs_PUBLIQUES-1-0.pdf](https://github.com/Voxaly/meae-consulaires-2026/releases/download/meae-consulaire-4.16.0.9/meae_vpi_n_specs_PUBLIQUES-1-0.pdf)**

Ce document décrit les spécifications techniques et fonctionnelles du système de vote par internet (VPI).

## Informations de publication

- **Version** : meae-consulaire-4.16.0.9
- **Date** : 2026-09-03 20:26:04
- **Commit** : 8ae4911
- **Auteur** : jenkins
...
├── webpack.election.config.js                          # Configuration de compilation électeur
├── src/
│   └── main/
│       └── webapp/
│           └── includes/
│               ├── election/
│               │   └── javascript/                     # Code source JS/TypeScript/React électeur
│               │       ├── *.js                        # Scripts JS électeur
│               │       └── vox-react/
│               │           ├── public/crypto/          # Bibliothèque crypto JS (runtime)
│               │           └── src/                    # Sources TypeScript/React (composants, pages, utils)
│               ├── commun/
│               │   └── javascript/                     # Utilitaires JS partagés
│               ├── dist/
│               │   └── election/                       # Bundles compilés
...
│               └── libs/
│                   └── crypto/                         # Bibliothèque cryptographique JS (ElGamal, ZKP)
└── crypto/                                             # Sources C de la bibliothèque edwards25519
    ├── Makefile
    ├── README.md
    └── src/
        └── main/
            ├── arithmetic/                             # Arithmétique sur courbes elliptiques (fe25519, sc25519)
            ├── crypto/                                 # Signature et PBKDF2
            ├── exports.c                               # Point d'entrée WebAssembly
            └── vote/                                   # Chiffrement ElGamal (elgamal.c)
```
...
- `app.bundle.js`: `48e032c5a637945ea00f7a21466ceee2a1643371e23d530f790cb60fd8749c22`
- `crypto.bundle.js`: `50fad4c0442990b2a9955613fd257df92401c9dfefbfefdf28e730729146208d`
- `315.chunk.js`: `c651afc6619cd78e2a78005852b565242c8f2f75d9e69ea3a548012dda6132a7`
- `354.chunk.js`: `768a2a1a68a2b6906cfbb532679b3486d86aeb053d5a23913231dc8cd2da869e`
- `500.chunk.js`: `dd526a088485da77923bf8a288d72a1be74d061812dcfd4dbc8fc5eb21d14bae`
---
...
1. **Vérifiez la version :** Assurez-vous de comparer le bon tag Git (meae-consulaire-4.16.0.9)
...
### Pour aller plus loin... (vérification par recompilation)

#### Prérequis

- Node.js v20.18.0 (version identique à celle du build Jenkins)
- npm **10.x** (inclus avec Node 20.18.0 — **ne pas utiliser npm@11**, incompatible avec ce lockfile)
- Java 17+ et Maven 3.6.3+

#### 1. Cloner et installer

```bash
git clone https://github.com/Voxaly/meae-consulaires-2026.git
cd meae-consulaires-2026
npm ci
```
...
**Résultat :** Deux développeurs compilant le même commit avec les mêmes dépendances doivent obtenir des fichiers identiques (byte-par-byte) avec les mêmes checksums.
...
1. Ouvrez les DevTools (F12) dans votre navigateur
